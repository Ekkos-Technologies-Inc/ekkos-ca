    ...
    <div className="min-h-screen bg-brutal-bg relative pb-40 text-white font-mono">
      ...
      <section className="relative pt-32 pb-24 z-10 border-b-8 border-brutal-white bg-brutal-black">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <div className="brutal-tag border-brutal-gray text-brutal-gray-light mb-8">LEGAL_DOC: PRIVACY_PROTOCOL</div>
      ...
      <section className="py-32 relative z-10">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
          <div className="brutal-card bg-black/40 border-white/10 p-10 space-y-12">
            <div>
              <h2 className="brutal-heading text-2xl mb-6 text-brutal-neon-pink">DATA_SOVEREIGNTY</h2>
              <p className="text-brutal-gray-light leading-relaxed">Your data is your intelligence. We do not sell, rent, or trade your memory layers. All private layers are accessible only by your authenticated agent sessions.</p>
            </div>
          </div>
        </div>
      </section>
